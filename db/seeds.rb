...
Achievement.create(name: "The Book Worm", description: "To complete this achievement, you must finish one book!", points: 50)
...
Achievement.create(name: "Rordon Gamsey", description: "To complete this achievement, you must learn a cooking recipe of your choice and prepare the meal yourself.", points: 150)
Achievement.create(name: "Kitchen Code 420", description: "To complete this achievement, you must learn a baking recipe and bake something of your choice. Disclaimer: you cannot complete this assignment by getting baked", points: 200)
...
Achievement.create(name: "RollerCoaster Rumpus", description: "To complete this achievement, you must ride a rollercoaster without vomiting, gross.", points: 50)
Achievement.create(name: "RollerCoaster Rumpus V2", description: "To complete this achievement, you must ride a rollercoaster with vomiting, wow that's a lot of points!", points: 100)
...
Achievement.create(name: "Fire Breather", description: "To complete this achievement, you must consume a ghost chili pepper and survive! If you don't survive, the point are not redeemable, yikes! Sorry!", points: 70)
...
Achievement.create(name: "S to the K to the I", description: "To complete this achievement, you must ski a mountain!", points: 70)
Achievement.create(name: "Snow Crawler", description: "To complete this achievement, you must go snowboarding!", points: 70)
...
Achievement.create(name: "Taylor Swift", description: "To complete this achievement, you must have had 10 or more relationships!", points: 100)
Achievement.create(name: "Freebie Friday", description: "To complete this achievement, just click complete!", points: 100)
Achievement.create(name: "Rob the Builder", description: "To complete this achievement, you must create a rails app!", points: 70)
Achievement.create(name: "Hmmmm..........", description: "To complete this achievement, you must have Mark explain something to you without making him say 'um' a SINGLE time!", points: 150)
Achievement.create(name: "American fish", description: "To complete this achievement, you must have James offer you his bag of Swedish Fish", points: 150)
...
Achievement.create(name: "Once in a Blue Moon", description: "To complete this achievement, you must make Max raise his voice at you, yikes!", points: 150)
